...
DEF_EX(exUnsupportedVersion,
       "Unsupported version of the storage info file format", Ex)
...
DEF_EX(exUnsupportedVersion,
       "Unsupported version of the extended storage info file format", Ex)

/// Saves the given ExtendedStorageInfo data into the given file
void save(string const &fileName, EncryptionKey const &,
          ExtendedStorageInfo const &);
