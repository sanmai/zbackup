...
class ZBackup : public ZBackupBase {
 ...
 public:
  ZBackup(string const &storageDir, string const &password, Config &configIn);
...
class ZRestore : public ZBackupBase {
 ...
 public:
  ZRestore(string const &storageDir, string const &password, Config &configIn);
  ...
  /// Starts NBD server that serves backup data as block device with random
  /// access
