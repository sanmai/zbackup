...
struct hash<Bundle::Id> {
  size_t operator()(Bundle::Id v) const { return *((size_t *)(v.blob)); }
};
}
...
void restore(ChunkStorage::Reader &, std::string const &backupData, DataSink *,
             ChunkSet *, ChunkMap *, SeekableSink *);
...
void restoreIterations(ChunkStorage::Reader &, BackupInfo &, std::string &,
                       ChunkSet *);
...
class IndexedRestorer : NoCopy {
 public:
  IndexedRestorer(ChunkStorage::Reader &chunkStorageReader,
