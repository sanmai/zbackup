...
class sptr_base {
 ...
 public:
  ...
  template <class TT>
  sptr_base(sptr_base<TT> const &other) : p((T *)other.p), count(other.count) {
    increment();
  }
  ...
  bool operator==(sptr_base const &other) const { return p == other.p; }
 ...
 protected:
  T *get_base(void) const { return p; }
};
...
class sptr : public sptr_base<T> {
 public:
  ...
  T *get(void) const { return sptr_base<T>::get_base(); }
...
class const_sptr : public sptr_base<T> {
 public:
  ...
  T const *get(void) const { return sptr_base<T>::get_base(); }

  T const *operator->(void)const { return get(); }
